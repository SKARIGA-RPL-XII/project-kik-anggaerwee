...
const FormLang = ({ type = "add", languageid }) => {
  ...
  const handleSubmit = (event) => {
    ...
    const data = {
      ...
      langcode: event.target.languagecd.value,
    };

    // console.log("data unntuk dikiirim",data)
      ...
      <div className="grid gap-4 grid-cols-2 py-4 md:py-6">
        ...
        <div className="col-span-2 sm:col-span-1">
          ...
          <input
            ...
            name="languagecd"
            value={languagecd}
            onChange={(e) => SetLanguagecd(e.target.value)}
            className="bg-neutral-secondary-medium border border-default-medium text-sm rounded-base w-full px-3 py-2.5"
            placeholder="Enter Languagename"
          />
        </div>
